...
if __name__ == "__main__":
    ...
    bag_folder = '/Data2/GCA_Demo/4864patch_dataset%d_patch' % (dataset)
    data_folder = '/Data2/GCA_Demo/4864patch_dataset%d' % (dataset)
    bag_csv_folder = '/Data2/GCA_Demo/4864patch_dataset%d_bag' % (dataset)
