...
from MIL_dataloader_csv_data2 import MILBags
import os

import copy
import matplotlib.pyplot as plt

from DeepAttnMISL_model_withResnet import DeepAttnMIL_Surv
import glob
...
def test(epoch, model, output_folder, batch_size = 4, mini_batch = 4):
    ...
    with torch.no_grad():
        ...
        df.to_csv(os.path.join(output_folder,'attention_score_dataset2_region.csv'), index = False)
...
if __name__ == "__main__":
    ...
    validation_loader = data_utils.DataLoader(MILBags(bag_root = '/Data3/GCA_Demo/4864patch_dataset2_bag',
                                                  MIL = True),
                                         batch_size=1,
                                         shuffle=False)
    ...
    output_folder = './results_stage1_clustering_dataset2'
