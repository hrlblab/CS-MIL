    ...
    with torch.no_grad():
        for batch_idx, (data, label, mask, root) in enumerate(validation_loader):
            ...
            for ki in range(len(root)):
                ...
                cross_scores = scale_attention[ki]#softmax(scale_attention[ki])
...
if __name__ == "__main__":
    ...
    train_loader = data_utils.DataLoader(MILBags(bag_root = '/Data2/GCA_Demo/Dataset1_Bag_1000_8_1/Train',
                                                  MIL = True),
                                         batch_size=1,
                                         shuffle=True,num_workers=8)


    validation_loader = data_utils.DataLoader(MILBags(bag_root = '/Data2/GCA_Demo/Dataset1_Bag_1000_8_1/Val',
                                                  MIL = True),
                                         batch_size=1,
    ...
    MODEL_PATH = glob.glob(os.path.join('results_stage1_clustering_dataset1_firstround', '*.pth'))[0]
