...
attention_df = pd.read_csv('/Data3/GCA_Demo/Image_stack#21/results_stage1_clustering_dataset2/attention_score_dataset2_region.csv')
...
for ci in range(len(classmarks)):
    ...
    for xi in range(0,3):
        for yi in range(0,3):
            now_x = xi * (1024 + 512) + 384 + 384
            now_y = yi * (1024 + 512) + 384 + 384
...
plt.savefig('No_multiple_instance_only1_dataset2.pdf')
...
plt.savefig('No_multiple_instance_only0_dataset2.pdf')
