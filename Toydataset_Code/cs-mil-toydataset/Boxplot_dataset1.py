...
attention_df = pd.read_csv('/Data2/GCA_Demo/Image_stack#21/results_stage1_clustering_dataset2/attention_score_dataset2_region.csv')
...
plt.savefig('No_multiple_instance_only1_dataset2.png')

X20_X10 = wilcoxon(df_1['20X'].tolist(), df_1['10X'].tolist())
X20_X5 = wilcoxon(df_1['20X'].tolist(), df_1['5X'].tolist())
X10_X5 = wilcoxon(df_1['10X'].tolist(), df_1['5X'].tolist())
...
plt.savefig('No_multiple_instance_only0_dataset2.png')
