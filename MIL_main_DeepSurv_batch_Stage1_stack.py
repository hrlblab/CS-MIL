...
if __name__ == "__main__":
    ...
    for ki in range(0,data_split):
        ...
        train_loader = data_utils.DataLoader(MILBags(data_csv_root='/Data2/GCA/CS-MIL_github/data_split_nonoverlap/data_list_%d.csv' % (now_split),
        ...
        validation_loader = data_utils.DataLoader(MILBags(data_csv_root='/Data2/GCA/CS-MIL_github/data_split_nonoverlap/data_list_%d.csv' % (now_split),
                                                    feature_csv_root='/Data2/GCA/simsiam/feature_cluster_multi-resolution_csv_local_severe_only256',
                                                    cluster_num=8,
                                                    size=(256, 256),
                                                    cluster_list=[0,1,2,3,4,5,6,7],
        ...
        test_loader = data_utils.DataLoader(MILBags(data_csv_root='/Data2/GCA/CS-MIL_github/data_list_%d.csv' % (now_split),
                                                    feature_csv_root='/Data2/GCA/simsiam/feature_cluster_multi-resolution_csv_local_severe_only256',
                                                    cluster_num=8,
                                                    size=(256, 256),
                                                    cluster_list=[0,1,2,3,4,5,6,7],
