...
class BYOL_transform: # Table 6 
    def __init__(self, image_size, normalize=imagenet_norm):
        ...
        self.transform1 = transforms.Compose([
            ...
            transforms.GaussianBlur(kernel_size=image_size//20*2+1, sigma=(0.1, 2.0)), # simclr paper gives the kernel size.
            # Kernel size has to be odd positive number with torchvision
            transforms.ToTensor(),
